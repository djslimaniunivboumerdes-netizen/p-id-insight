  ...
  return (
    <div>
      ...
      <div className="space-y-4 p-4 md:p-6">
        ...
        {q.isLoading && <LoadingState label="Loading findings…" />}
        {q.isError && <ErrorState error={q.error} onRetry={() => q.refetch()} label="Couldn't load findings." />}
        {q.isEmpty && <EmptyState label="No findings reported." />}

        {!q.isLoading && !q.isError && issues.length > 0 && (
