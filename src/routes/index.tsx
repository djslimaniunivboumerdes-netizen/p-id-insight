...
import { projects, issues, equipment } from "@/lib/mock-data";
...
function Dashboard() {
  const stats = [
    { label: "Active Projects", value: "4", trend: "+1 this week", icon: FileText },
    { label: "Equipment Detected", value: "1,284", trend: "98.2% confidence", icon: Boxes },
    { label: "Open Issues", value: "23", trend: "6 critical", icon: ShieldAlert },
